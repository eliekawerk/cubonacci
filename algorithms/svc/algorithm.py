...
class Algorithm:
    ...
    def __init__(self, log_C, kernel, shrinking):
        ...
        the algorithm but also for the preprocessor which is considered to be part of the Algorithm. In this example support
    ...
    def fit(self, X, y):
        ...
        self.model = SVC(C=np.exp(self.log_C), shrinking=self.shrinking, kernel=self.kernel, probability=True)
